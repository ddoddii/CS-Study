...
DHCP는 Dynamic Host Configuration Protocol로, 호스트가 네트워크에 접속했을 때 자동으로 IP주소를 할당하기 위한 프로토콜입니다. DHCP 는 서버-클라이언트 모델로, 클라이언트는 네트워크에 접속하고자 하는 호스트이고, 서버는 네트워크 서버입니다. 
...
### **10. OSI 7계층에 대해 설명해 주세요. ⭐️**

<details>
<summary>OSI 7계층 & 프로토콜</summary>

<img width="455" alt="image" src="https://github.com/ddoddii/ddoddii.github.io/assets/95014836/71ba7f0b-5b55-419e-b38a-0eae9269a6a3">
...
- **Transport Layer와, Network Layer의 차이에 대해 설명해 주세요.**
  - Network Layer 는 3계층으로, 주요 책임은 데이터 패킷을 소스에서 목적지까지 라우팅하는 것입니다. 이 계층에서는 데이터 패킷이 네트워크의 여러 라우터를 거쳐 최종 목적지로 전송됩니다. 
  - Transport Layer 는 4계층으로, 애플리케이션 간의 신뢰성 있는 데이터 전송을 보장합니다. 이
